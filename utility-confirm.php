...
if (!$ut->valid_csrf()){
	...
	$ut->redirect_with_errors('utility-confirm.php', $error);
	exit();
}
...
<?php require '_templates/backend/header.php'; ?>
     ...
     <div class="col-md-9">
			...
			<?php
				...
				if(!$recepient){
				echo "<h2 style='color:red;'> The Recepient doesn't exist! </h2>";
			}
			
			

			if( ($auth_user[0]->balance < 1) || ($auth_user[0]->balance < $_POST['transfer_amount']) ){
      ...
      <table class='table table-striped custab' >
        ...
        <tbody>
          ...
          <tr>
            ...
            <form action='utility-process.php' method='POST'>
        ...
        <button class='btn btn-outlined btn-block btn-primary' type='submit'><i class='icon-login'></i> Pay Bill</button>";
